  ...
  return (
    <header className="header">
      <div className="header__nav-mobile">
        ...
        <ul className="header__nav-mobile-links hide">
          <li className="header__nav-mobile-link">
            <Link to="/headphones" onClick={()=>hideMenu()}>
              <NavItemMobile
          ...
          <li className="header__nav-mobile-link">
            <Link to="/speakers" onClick={()=>hideMenu()}>
              <NavItemMobile
                className="header__mobile-nav-item"
                menuName={"Speakers"}
                src={speakersHero}
          ...
          <li className="header__nav-mobile-link">
            <Link to="/earphones" onClick={()=>hideMenu()}>
              <NavItemMobile
                className="header__mobile-nav-item"
                menuName={"Earphones"}
                src={earphonesHero}
